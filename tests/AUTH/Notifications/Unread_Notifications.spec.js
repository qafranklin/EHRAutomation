...
test('@authregression Access Unread Notifications', async ({ page }) => {
...
await expect(isunread).toHaveClass(/btn btn-default fastclickable active/);//verify if the unread button 

await page.locator('#all').click();

await expect(isunread).toHaveClass(/btn btn-default fastclickable/);
