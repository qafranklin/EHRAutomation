...
test('Upload Image ', async ({ page }) => {
 ...
 try {
  ...
  await expect(Ischangeprofile.Uploadphotomodal).toBeVisible();
  ...
  //Upload Image File
  const filePath = 'C:\\Users\\BIZBOX\\Desktop\\MPH GIF\\doctorimage.png';  // Corrected file path for Windows
 ...
 await expect(Ischangeprofile.uploadtoaster).toContainText('Photo successfully uploaded.');
