...
test('Disable Telemed User ', async ({ page }) => {
 ...
 try {
  ...
  await telemedselectors.istelemeduser.uncheck();
 ...
 await expect(telemedselectors.istelemeduser).not.toBeChecked();
